...
import { useMarketingCoach, type CoachResult } from '@/hooks/useMarketingCoach';
        ...
        <AnimatePresence mode="wait">
          {isExpanded ? (
                ...
                {coach.tips.map((tip) => (
                  <motion.div
                    ...
                    className={`p-3 rounded-lg text-sm ${
                      tip.completed
                        ? 'bg-coach-success/10 text-coach-success'
            ...
            <motion.button
              ...
              className="bg-gradient-to-br from-primary to-secondary text-white rounded-2xl shadow-xl p-4 flex items-center gap-3"
            >
              <div className="relative">
                <Trophy className="w-6 h-6" />
                {coach.score === 100 && (
                  <motion.div
                    className="absolute -top-1 -right-1 w-3 h-3 bg-coach-success rounded-full"
