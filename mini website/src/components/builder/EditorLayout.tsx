...
export const EditorLayout = ({ siteConfig }: EditorLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex flex-col">
      {/* Top Bar */}
      <header className="bg-card border-b px-4 py-3 flex items-center justify-between shrink-0 z-10">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="boss-mode" className="flex items-center gap-1 text-sm cursor-pointer">
              ...
              <span className="hidden sm:inline">Boss Mode</span>
            </Label>
          </div>
      ...
      <div className="flex flex-1 overflow-hidden flex-col md:flex-row relative">
        ...
        {/* Preview Panel */}
        <main className={`flex-1 overflow-auto bg-muted/50 flex items-start justify-center ${isMobile ? 'p-0' : 'p-4 md:p-6'}`}>
          <motion.div
