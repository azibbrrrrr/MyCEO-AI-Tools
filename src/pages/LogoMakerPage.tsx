            ...
            {logos.map((logo, index) => (
              ...
              >
                <img
                  ...
                  className="w-full aspect-square object-contain rounded-xl bg-[var(--bg-muted)]"
                />
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-40 flex items-center justify-center">
          <div className="bg-white rounded-3xl p-8 text-center max-w-md mx-4 animate-scale-in">
            ...
            <div className="space-y-3">
              ...
              <Link
                to="/dashboard"
                className="block w-full px-8 py-3 rounded-full bg-white border-2 border-[var(--border-light)] text-[var(--text-secondary)] font-semibold hover:border-[var(--sky-blue)] transition-all"
              >
                {t("common.back")}
              </Link>
            </div>
