...
const translations: Record<string, Record<Language, string>> = {
  ...
  "dashboard.backToPortal": { EN: "Back to Portal", BM: "Kembali ke Portal" },
  ...
  // AI Sales Buddy
  "tool.salesBuddy": { EN: "AI Sales Buddy", BM: "AI Sales Buddy" },
  "tool.salesBuddy.desc": { EN: "Practice your sales pitch!", BM: "Latih teknik jualan anda!" },
  "salesBuddy.intro.title": { EN: "Sales Training", BM: "Latihan Jualan" },
  "salesBuddy.intro.desc": { EN: "Practice selling to different customers", BM: "Berlatih menjual kepada pelanggan berbeza" },
  "salesBuddy.start": { EN: "Start Practice", BM: "Mula Latihan" },
  "salesBuddy.selectProduct": { EN: "What are you selling?", BM: "Apa yang anda jual?" },
  "salesBuddy.selectProduct.desc": { EN: "Pick your product type", BM: "Pilih jenis produk anda" },
  "salesBuddy.productName": { EN: "Product Name", BM: "Nama Produk" },
  "salesBuddy.productPrice": { EN: "Price", BM: "Harga" },
  "salesBuddy.selectCustomer": { EN: "Who is your customer?", BM: "Siapa pelanggan anda?" },
  "salesBuddy.selectCustomer.desc": { EN: "Each customer has different needs", BM: "Setiap pelanggan ada keperluan berbeza" },
  "salesBuddy.product.food": { EN: "Food", BM: "Makanan" },
  "salesBuddy.product.drinks": { EN: "Drinks", BM: "Minuman" },
  "salesBuddy.product.gifts": { EN: "Gifts", BM: "Hadiah" },
  "salesBuddy.product.others": { EN: "Others", BM: "Lain-lain" },
  "salesBuddy.customer": { EN: "Customer", BM: "Pelanggan" },
  "salesBuddy.customer.friendly": { EN: "Friendly Customer", BM: "Pelanggan Ramah" },
  "salesBuddy.customer.friendly.desc": { EN: "Easy going, likes to chat", BM: "Senang mesra, suka berbual" },
  "salesBuddy.customer.picky": { EN: "Picky Customer", BM: "Pelanggan Cerewet" },
  "salesBuddy.customer.picky.desc": { EN: "Asks many questions", BM: "Banyak soalan" },
  "salesBuddy.customer.bargain": { EN: "Bargain Hunter", BM: "Kaki Tawar" },
  "salesBuddy.customer.bargain.desc": { EN: "Wants discounts", BM: "Suka minta diskaun" },
  "salesBuddy.customerMood": { EN: "Customer Mood", BM: "Mood Pelanggan" },
  "salesBuddy.options": { EN: "Suggested Options (CHOOSE OR TYPE)", BM: "Pilihan Jawapan (BOLEH PILIH ATAU TAIP SENDIRI)" },
  "salesBuddy.typeOwn": { EN: "Or type your own response", BM: "Atau taip jawapan sendiri" },
  "salesBuddy.typeHere": { EN: "Type your answer...", BM: "Taip jawapan anda..." },
  "salesBuddy.viewResults": { EN: "View Results", BM: "Lihat Keputusan" },
  "salesBuddy.tryAgain": { EN: "Try Again", BM: "Cuba Lagi" },
  "salesBuddy.result.success": { EN: "Great Job!", BM: "Tahniah!" },
  "salesBuddy.result.fail": { EN: "Session Ended", BM: "Sesi Tamat" },
  "salesBuddy.result.fail.desc": { EN: "It's okay, not every customer buys", BM: "Takpe, tak semua pelanggan akan beli" },
  "salesBuddy.analysis": { EN: "AI Analysis", BM: "Analisa AI" },
  ...
  // Logo Maker V2
  "logoV2.header.title": { EN: "Logo Maker Studio", BM: "Studio Pembuat Logo" },
  "logoV2.header.back": { EN: "Back", BM: "Kembali" },
  "logoV2.premium.count": { EN: "Premium", BM: "Premium" },
  "logoV2.premium.out": { EN: "Out of Premium Credits", BM: "Kredit Premium Habis" },
  "logoV2.label.businessName": { EN: "Business Name", BM: "Nama Perniagaan" },
  "logoV2.placeholder.businessName": { EN: "e.g., Rainbow Stars", BM: "cth., Bintang Pelangi" },
  "logoV2.label.businessType": { EN: "What do you sell?", BM: "Apa yang anda jual?" },
  "logoV2.label.logoStyle": { EN: "Logo Style", BM: "Gaya Logo" },
  "logoV2.label.vibe": { EN: "Vibe", BM: "Vibe" },
  "logoV2.label.colors": { EN: "Colors", BM: "Warna" },
  "logoV2.label.icons": { EN: "Add Icons (up to 3)", BM: "Tambah Ikon (sehingga 3)" },
  "logoV2.text.selected": { EN: "selected", BM: "dipilih" },
  "logoV2.label.slogan": { EN: "Slogan (optional)", BM: "Slogan (pilihan)" },
  "logoV2.placeholder.slogan": { EN: "e.g., Play with magic!", BM: "cth., Main dengan magis!" },
  "logoV2.button.generateFree": { EN: "Generate Free (3 logos)", BM: "Jana Percuma (3 logo)" },
  "logoV2.button.generatePremium": { EN: "Generate Premium (1 logo)", BM: "Jana Premium (1 logo)" },
  "logoV2.button.creating": { EN: "Creating...", BM: "Sedang Cipta..." },
  "logoV2.preview.title": { EN: "Preview", BM: "Pratonton" },
  "logoV2.preview.start": { EN: "Start by entering your business name...", BM: "Mula dengan masukkan nama perniagaan..." },
  "logoV2.generating.title": { EN: "Creating your logos...", BM: "Mencipta logo anda..." },
  "logoV2.results.title": { EN: "Your Logos", BM: "Logo Anda" },
  "logoV2.results.selected": { EN: "Selected!", BM: "Dipilih!" },
  "logoV2.results.pick": { EN: "Pick This!", BM: "Pilih Ini!" },
  "logoV2.selection.title": { EN: "Your Logo is Ready!", BM: "Logo Anda Dah Siap!" },
  "logoV2.button.download": { EN: "Download", BM: "Muat Turun" },
  "logoV2.button.dashboard": { EN: "Dashboard", BM: "Dashboard" },
  "logoV2.empty.title": { EN: "Ready to create your logo!", BM: "Sedia untuk cipta logo!" },
  "logoV2.empty.desc": { EN: "Fill in your business details on the left and click Generate", BM: "Isi butiran perniagaan di kiri dan klik Jana" },
  "logoV2.error.noName": { EN: "Please enter a business name", BM: "Sila masukkan nama perniagaan" },
  "logoV2.error.noPremium": { EN: "You have used all your premium generations.", BM: "Anda telah guna semua janaan premium." },

  // Creations Page
  "creations.title": { EN: "My Creations", BM: "Karya Saya" },
  "creations.subtitle": { EN: "All the amazing logos you've created!", BM: "Semua logo hebat yang anda cipta!" },
  "creations.loading": { EN: "Loading your gallery...", BM: "Memuatkan galeri anda..." },
  "creations.empty.title": { EN: "No creations yet!", BM: "Belum ada karya!" },
  "creations.empty.desc": { EN: "Start your creative journey by making your first logo.", BM: "Mulakan perjalanan kreatif dengan logo pertama anda." },
  "creations.button.create": { EN: "Create My First Logo", BM: "Cipta Logo Pertama Saya" },
  "creations.date.today": { EN: "Today", BM: "Hari Ini" },
  "creations.date.yesterday": { EN: "Yesterday", BM: "Semalam" },
  "creations.date.daysAgo": { EN: "days ago", BM: "hari lepas" },
  "creations.dialog.delete.title": { EN: "Delete Logo?", BM: "Padam Logo?" },
  "creations.dialog.delete.message": { EN: "This will permanently remove this logo from your creations. This action cannot be undone.", BM: "Ini akan memadam logo ini kekal. Tindakan ini tidak boleh dikembalikan." },
  "creations.dialog.delete.confirm": { EN: "Delete", BM: "Padam" },
  "creations.dialog.delete.cancel": { EN: "Keep It", BM: "Simpan" },

  // Logo Zoom Modal
  "modal.zoom.download": { EN: "Download", BM: "Muat Turun" },
  "modal.zoom.pick": { EN: "Pick This One!", BM: "Pilih Yang Ini!" },
  "modal.zoom.delete": { EN: "Delete Logo", BM: "Padam Logo" },
  "modal.zoom.setCompany": { EN: "Set as Company Logo", BM: "Tetapkan Logo Syarikat" },

  // Loading Showcase
  "loading.title": { EN: "Loading Style Showcase", BM: "Pameran Gaya Memuatkan" },
  "loading.skeleton": { EN: "Skeleton Loader", BM: "Pemuat Rangka" },
  "loading.skeleton.desc": { EN: "Used for: Content placeholders (cards, text)", BM: "Digunakan untuk: Pemegang tempat kandungan (kad, teks)" },
  "loading.rocket": { EN: "Rocket Spinner", BM: "Pemuat Roket" },
  "loading.rocket.launching": { EN: "Launching AI Tools...", BM: "Melancarkan Alatan AI..." },
  "loading.rocket.desc": { EN: "Used for: Full page loads, \"launching\" states", BM: "Digunakan untuk: Muat halaman penuh, status \"melancarkan\"" },
  "loading.lucide": { EN: "Lucide Spinner", BM: "Pemuat Lucide" },
  "loading.lucide.saving": { EN: "Saving...", BM: "Menyimpan..." },
  "loading.lucide.desc": { EN: "Used for: Buttons, inline actions", BM: "Digunakan untuk: Butang, tindakan baris" },
  "loading.typing": { EN: "Typing Dots", BM: "Titik Mengetip" },
  "loading.typing.desc": { EN: "Used for: Chat, AI thinking", BM: "Digunakan untuk: Sembang, AI berfikir" },
  "loading.circular": { EN: "Circular Progress (Logo Maker)", BM: "Kemajuan Bulatan (Pembuat Logo)" },
  "loading.circular.starting": { EN: "Starting...", BM: "Bermula..." },
  "loading.circular.generating": { EN: "Generating...", BM: "Menjana..." },
  "loading.circular.done": { EN: "Done!", BM: "Siap!" },
  "loading.circular.desc": { EN: "Used for: Multi-step or long-running generation processes where progress is tracked.", BM: "Digunakan untuk: Proses janaan pelbagai langkah yang panjang." },
  "loading.premium.title": { EN: "New Premium Concepts", BM: "Konsep Premium Baru" },
  "loading.premium.a": { EN: "Option A: Orbiting Rings", BM: "Pilihan A: Cincin Orbit" },
  "loading.premium.a.desc": { EN: "Tech-forward, precise, elegant.", BM: "Canggih, tepat, elegan." },
  "loading.premium.b": { EN: "Option B: Pulsing Brand", BM: "Pilihan B: Jenama Berdenyut" },
